...
const translations: Record<Lang, Record<string, string>> = {
  uz: {
    ...
    // Main
    addTask: "Vazifa qo'shish", smartPlaceholder: "9 da uchrashuv... (rus/eng tilida ham)",
  ...
  ru: {
    ...
    addTask: "Добавить задачу", smartPlaceholder: "в 9 встреча... (на узб тоже можно)",
  ...
  en: {
    ...
    addTask: "Add task", smartPlaceholder: "9 meeting... (uzb/rus also works)",
