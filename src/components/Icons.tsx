...
export function MicIcon({ size = 16, className, style }: IconProps & { style?: React.CSSProperties }) {
  return (
...
export function SparkleIcon({ size = 16, className, style }: IconProps & { style?: React.CSSProperties }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
