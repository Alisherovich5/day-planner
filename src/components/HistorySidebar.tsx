  ...
  return (
    <>
      ...
      <div className={`sidebar w-[240px] h-screen overflow-y-auto flex-shrink-0 flex flex-col ${open ? "sidebar-open" : ""}`}
        ...
        <div className="px-3 py-1" style={{ borderTop: "1px solid var(--border-light)" }}>
          <a href="/settings" onClick={() => onClose()}
            ...
            style={{ color: "var(--text-3)", textDecoration: "none", display: "flex" }}
            ...
            <span className="text-[11px]">{t("language") === "Til" ? "Sozlamalar" : t("language") === "Язык" ? "Настройки" : "Settings"}</span>
          </a>
        </div>
